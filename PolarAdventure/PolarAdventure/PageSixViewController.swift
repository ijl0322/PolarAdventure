...
class PageSixViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        story?.attributedText = ReadToMe.player.pageSixString
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        UserDefaults.standard.set(5, forKey: "bookmark")
